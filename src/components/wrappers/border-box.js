export const BorderBox = ({ children, joinTop = false, joinBottom = false }) => {
  return (
    <div className='w-full'>
      ...
      >
        <div className='border border-dashed border-t-0 border-r-0 border-l-0'></div>
        <div className='border border-dashed border-t-0'></div>
        <div className='border border-dashed border-t-0 border-l-0 border-r-0'></div>
      </div>
      ...
      >
        <div className='border border-dashed border-t-0 border-b-0 border-r-0 border-l-0'></div>
        <div className='border border-dashed border-t-0 border-b-0'></div>
        <div className='border border-dashed border-t-0 border-b-0 border-l-0 border-r-0'></div>
      </div>
    </div>
  );
};